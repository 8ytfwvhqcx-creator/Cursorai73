...
<?php if ($requireMath) : ?>
    <div class="antibot-math">
        <label for="human_sum">Vérification : combien font <?= htmlspecialchars(app_math_question_display(), ENT_QUOTES, 'UTF-8') ?> ?</label>
        <input type="text" name="human_sum" id="human_sum" inputmode="numeric" pattern="[0-9]*" maxlength="3" required autocomplete="off">
    </div>
<?php endif; ?>
